  ...
  Samantha.Router.prototype = $.extend({}, Samantha.Object.prototype, {
    ...
    bindDelegate: function() {
      ...
      $(document).bind('click.samantha keypress.samantha', function(e){
        ...
        if (e.type === 'click') {
          ...
          {
            case 'A':
              console.log('click on a link', e);
              path = target.attr('href');
              router.runRoute('get', path, params);
              break;
            case 'INPUT':
              console.log('click on a input', target);
              router.runRoute(verb, path, params);
              break;
            case 'BUTTON':
              console.log('click on a button', target);
              router.runRoute(verb, path, params);
              break;
            default:
              return true;
    ...
    lookupRoute: function(verb, path) {
      ...
      if (typeof this._routes[verb] != 'undefined') {
        this.each(this._routes[verb], function(i, route) {
