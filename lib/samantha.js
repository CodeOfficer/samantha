...
(function($) {
  ...
  // --
  // slightly modified for Samantha for caching templates by name
...
(function($) {
  ...
  Samantha.VERSION = '0.2.0';
  
  // == Samantha.Object
  //
  // Samantha.Object is the base for all other Samantha classes. It provides some useful 
  // functionality, including cloning, iterating, etc.
  Samantha.Object = Class.extend({
    
    // Extend the passed object as a Samantha.Object
    init: function(set) {
      $.extend(this, set);
    },
    ...
    // For example. Given this Samantha.Object:
    //    
    //    var s = new Samantha.Object({first_name: 'Samantha', last_name: 'Davis Jr.'});
    //    s.toHTML() //=> '<strong>first_name</strong> Samantha<br /><strong>last_name</strong> Davis Jr.<br />'
    //
    toHTML: function() {
      var display = "";
      this.each(function(k, v) {
    ...
    // the properties of this Samantha.Object
    each: function() {
  ...
  //
  // Samantha.Application is the Base prototype for defining 'applications'.
  // An 'application' is a collection of 'routes' and bound events that is
  // attached to an element when <tt>run()</tt> is called.
  //
  Samantha.Application = Samantha.Object.extend({
    ...
    // Initializes a new Samantha.Application.
    ...
    init: function(app_function) {
      ...
      this.context_prototype = Samantha.EventContext.extend({});
    ...
    // //=> Samantha.Application: body
    toString: function() {
      return 'Samantha.Application:' + this.element_selector;
    },
    ...
    // For great detail on routes, check out: http://code.quirkey.com/samantha/doc/routes.html
    //
    ...
    //
    // See http://code.quirkey.com/samantha/docs/events.html for more info.
    //
    ...
    //              If no context is supplied a the context is a new <tt>Samantha.EventContext</tt>
    //
    ...
    // the current <tt>Samantha.EventContext</tt>
    //
    ...
    // === Example
    // 
    //    var app = $.samantha(function() { ... }); // your application
    ...
    // <tt>Samantha.EventContext</tt>. If the route can not be found, it calls 
  ...
  // 
  // <tt>Samantha.EventContext</tt> objects are created every time a route is run or a 
  // bound event is triggered. The callbacks for these events are evaluated within a <tt>Samantha.EventContext</tt>
  // This within these callbacks the special methods of <tt>EventContext</tt> are available.
  // 
  // === Example
  //
  //  $.samantha(function() { with(this) {
  //    // The context here is this Samantha.Application
  //    get('#/:name', function() { with(this) {
  //      // The context here is a new Samantha.EventContext
  //      if (params['name'] == 'samantha') {
  //        partial('name.html.erb', {name: 'Samantha'});
  //      } else {
  ...
  //  }});
  //
  Samantha.EventContext = Samantha.Object.extend({
    
    // Initialize a new EventContext
    //
    // === Arguments
    //
    // +app+::    The <tt>Samantha.Application</tt> this event is called within.
    // +verb+::   The verb invoked to run this context/route.
    // +path+::   The string path invoked to run this context/route.
    // +params+:: An Object of optional params to pass to the context. Is converted
    //            to a <tt>Samantha.Object</tt>.
    init: function(app, verb, path, params) {
      this.app    = app;
      this.verb   = verb;
      this.path   = path;
      this.params = new Samantha.Object(params);
    },
    ...
    //
    //      partial('doc.html.erb', {name: 'Samantha'}); 
