...
// ----------------------------------------------------------------------------
  ...
  // Samantha.Router = function(reset){
  //   if (reset) {
  ...
  Samantha.RouterFactory.prototype = {
    ...
    getRouterInstance: function(key){
      // console.log(key, this.routers);
      // console.log('calling getRouterInstance with: ', key, this.routers[key]);
      if (this.routers[key] === undefined) {
        this.routers[key] = new Samantha.Router(key);
      };
      
      console.log(key, this.routers[key]);
