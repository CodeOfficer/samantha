...
// ----------------------------------------------------------------------------
  ...
  Samantha.Router = function(unique) {
  ...
  Samantha.RouterFactory = function(unique) {
    this.unique = unique || false;
  };
  
  Samantha.RouterFactory.prototype = {
    ...
    getInstance: function(){
      ...
      if (this.unique==true) {
        return new Samantha.Router(true);
      };
      
      if (!this.last_router) {
        this.last_router = new Samantha.Router(false);
      };
      
      return this.last_router;
    }
...
// ----------------------------------------------------------------------------
  ...
  Samantha.Application = function(app_function){
    ...
    this.router = new Samantha.RouterFactory().getInstance();
