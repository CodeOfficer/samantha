(function($) {
  // $(function() {
    with(jqUnit) {
      ...
      context('Samantha.Application', 'route', {
        before: function() {
          this.app = new Samantha.Application(function() {
      ...
      context('Samantha.Application', 'bind', {
        before: function() {
          var context = this;
      ...
      context('Samantha.Application','run', {
        before: function () {
          $('.get_area').text('');
          this.app = new Samantha.Application(function() {
      ...
      .should('attach application instance to element', function() {
        this.app.run();
        isObj($('#main').data('samantha-app'), this.app);
        this.app.unload();
      })
      ...
      .should('bind events to all forms', function() {
        ...
        app.run('#/');
        $('form').submit();
        matches(/samantha-app/, $('form')[0].className);
        soon(function() {
      ...
      .should('bind events only to the samantha app namespace', function() {
        var app = this.app;
      ...
      context('Samantha.Application','lookupRoute', {
        before: function() {
          this.app = new Samantha.Application(function() {
            this.route('get', /\/blah\/(.+)/, function() {
              $('#main').trigger('click');
      ...
      context('Samantha.Application','runRoute', {
        before: function() {
          var context = this;
          this.app = new Samantha.Application(function() {
            this.route('get', /\/blah\/(.+)/, function() {
      ...
      context('Samantha.Application','before', {
        before: function() {
          var context = this;
          context.before  = {};
          context.route   = {};
      ...
      context('Samantha.Application','after', {
        before: function() {
          var context = this;
          context.after  = {};
          context.route   = {};
      ...
      context('Samantha.Application','helpers', {
        before: function() {
          var context = this;
      ...
      context('Samantha.Application', 'getLocation', {
        before: function() {
          this.app = new Samantha.Application(function() {
            
          });
          
          this.override_app = new Samantha.Application(function() {
      ...
      context('Samantha.Application', 'setLocation', {
        before: function() {
          this.app = new Samantha.Application(function() {
      ...
      context('Samantha.Application', 'post routes', {
        before: function() {
          var context = this;
          context.visited = [];
          context.location = "";
